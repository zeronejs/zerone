...
import { WechatPayChoosePayService, WechatPayChoosePayServiceAppInput } from './choosePay';
 ...
 */
@Injectable()
export class WechatPayAppService {
	constructor(
	...
	async unifiedorder(params: AppNativeUnifiedTransactionsRequestParams) {
		return this.unifiedorderService.app(params);
	}
	/**
	 * 订单查询
	 */
	 ...
	 * 获取调起支付的参数
	 */
	async getChoosePayParams(params: WechatPayChoosePayServiceAppInput) {
		return this.choosePayService.app(params);
	}
	/**
	 * 申请退款
	 */
